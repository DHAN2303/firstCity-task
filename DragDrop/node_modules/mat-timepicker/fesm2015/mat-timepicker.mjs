...
class MatTimepickerDirective {
    ...
    ngOnInit() {
        var _a, _b, _c, _d;
        if (this.ngControl && ((_a = this.ngControl.control) === null || _a === void 0 ? void 0 : _a.parent)) {
            ...
            this.required = !!(control === null || control === void 0 ? void 0 : control.hasValidator(Validators.required));
        }
        else if (this.ngControl) {
            const control = ((_d = (_c = (_b = this.ngControl) === null || _b === void 0 ? void 0 : _b.formDirective) === null || _c === void 0 ? void 0 : _c.control) === null || _d === void 0 ? void 0 : _d.get(this.ngControl.path)) || null;
            this.required = !!(control === null || control === void 0 ? void 0 : control.hasValidator(Validators.required));
        }
